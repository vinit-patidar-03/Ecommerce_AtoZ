...
const CategoryCard = ({ category }) => {
    ...
    return (
        <>
            <Link to={`${category}`} className="w-[50px] h-[50px] sm:w-[100px] sm:h-[100px] shadow-[0_0px_5px_rgba(0,0,0,0.3)] p-2 rounded-lg hover:transition-all hover:bg-slate-100 transition-all ">
